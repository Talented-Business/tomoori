...
<table class ="<?php echo $show_activation?>">
	<tr valign="top" ">
		<td style="width:50%;font-weight:800;">
			<label for="woocommerce_wf_dhl_shipping_title">Licence Activation</label>
		</td>
		<td scope="row" class="titledesc" style="display: block;margin-bottom: 20px;margin-top: 3px;">
		<fieldset style="padding:3px;">
		<label >API License Key</label> <span class="woocommerce-help-tip"></span> <br/>
				<input type="text" class="txt-api-key aw-textbox" placeholder="License Key" value="" id="txt_licence_key">
		</fieldset>
		<fieldset style="padding:3px;">
		<label >License Email</label> <span class="woocommerce-help-tip"></span> <br/>
		<input type="text" id="txt_email" class="aw-textbox txt-api-key" placeholder="License Email" value="">
			
		</fieldset>
		<fieldset style="padding:3px;">
		<input type="button" id="btn_licence_activate" class="aw-button aw-main-button" value="Activate">
<br>
<p class="">Check <a href="//elextensions.com/my-account" target="_blank">My Account</a> for API Keys and API Downloads.</p><br>			
		</fieldset>
