...
if(isset($_POST['wf_dhl_rates_save_changes_button']))
{
    ...
    $wc_main_settings['elex_dhl_cutoff_time'] = isset($_POST['elex_dhl_cutoff_time'])? $_POST['elex_dhl_cutoff_time']: '23:59';
    $wc_main_settings['elex_dhl_insurance_for_specific_countries'] = isset($_POST['elex_dhl_insurance_for_specific_countries']) && !empty($_POST['elex_dhl_insurance_for_specific_countries'])? $_POST['elex_dhl_insurance_for_specific_countries']: array();
    $wc_main_settings['countries_to_hide_selected'] = isset($_POST['wf_dhl_shipping_hide_services'])? 'yes': 'no';
    $wc_main_settings['countries_to_hide_services'] = isset($_POST['wf_dhl_shipping_hide_for_countries'])? $_POST['wf_dhl_shipping_hide_for_countries']: ''; 
