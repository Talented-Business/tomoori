...
if(isset($_POST['wf_dhl_validate_credentials']))
{
    ...
    $validate = wf_validate_crendials($site_test_mode,$site_id,$site_pwd,$site_country);
...
function wf_validate_crendials($site_test_mode,$site_id,$site_pwd,$site_country)
{
