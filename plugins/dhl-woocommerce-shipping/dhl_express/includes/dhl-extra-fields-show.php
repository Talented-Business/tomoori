        ...
        class WF_Dhl_Extra_Meta_Fields_Class
        {
            ...
            function wf_dhl_custom_override_checkout_fields( $fields ) {
                ...
                if(!empty($insurance_specific_countries)){
                    if(in_array($this->destination_country, $insurance_specific_countries)){
            ...
            public function wf_add_extra_charges( $label, $method ) {
                ...
                if( isset($extra_charges['weight_charge']) ){
                    ...
                    if(isset($extra_charges['insurance_charge']) && $this->settings['show_dhl_insurance_charges'] == 'yes'){
                        $extra_charges_html = "<br /><small>".__('Weight Charges: ', 'wf-shipping-dhl'). wc_price($extra_charges['weight_charge']). ' + '.__('DHL Handling Charges: ', 'wf-shipping-dhl'). wc_price($extra_charges['extra_charge']).' (Inc Tax,Ship,etc.) </small>'.$tax_calculation_html.' + <small>'.__('DHL Insurance Charges: ', 'wf-shipping-dhl').wc_price($extra_charges['insurance_charge'])."</small>";
                    }

                    if(isset($extra_charges['remote_area_surcharge']) && $this->settings['show_dhl_remote_area_surcharge'] == 'yes'){
                        if($this->settings['show_dhl_insurance_charges'] == 'yes' && isset($extra_charges['insurance_charge'])){
                            $extra_charges_html = "<br /><small>".__('Weight Charges: ', 'wf-shipping-dhl'). wc_price($extra_charges['weight_charge']). ' + '.__('DHL Handling Charges: ', 'wf-shipping-dhl'). wc_price($extra_charges['extra_charge']).' (Inc Tax,Ship,etc.) </small>'.$tax_calculation_html.' + <small>'.__('DHL Insurance Charges: ', 'wf-shipping-dhl').wc_price($extra_charges['insurance_charge'])."</small> + <small>".__('DHL Remote Area Surcharge: ', 'wf-shipping-dhl').wc_price($extra_charges['remote_area_surcharge'])."</small>";
                        }else{
                            $extra_charges_html = "<br /><small>".__('Weight Charges: ', 'wf-shipping-dhl'). wc_price($extra_charges['weight_charge']). ' + '.__('DHL Handling Charges: ', 'wf-shipping-dhl'). wc_price($extra_charges['extra_charge']).' (Inc Tax,Ship,etc.) </small>'.$tax_calculation_html.' +  <small>'.__('DHL Remote Area Surcharge: ', 'wf-shipping-dhl').wc_price($extra_charges['remote_area_surcharge'])."</small>";
                        }
