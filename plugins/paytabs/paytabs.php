...
*     Version: 2.2
*     Author: PayTabs
*     Author URL: http://paytabs.paytabs.com
*
********************************************************************************************************************************/
@session_start();
...
//extend wc_payment_gateway class and create ad class
  class WC_Gateway_Paytabs_creditcard_wc extends WC_Payment_Gateway{
    public function __construct(){
          ...
          $this->id            =   'paytabs';
          $this->icon          =   apply_filters( 'woocommerce_paytabs_icon', $pluginpath[0] . 'plugins/paytabs/icons/paytabs.png' );
          ...
          if(isset($this->settings['redirect_page_id']))$this->redirect_page_id = $this->settings['redirect_page_id'];
          //live payment url
