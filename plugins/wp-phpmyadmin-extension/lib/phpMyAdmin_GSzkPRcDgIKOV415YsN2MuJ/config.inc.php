...
$cfg['blowfish_secret']					= '+{XMJI;_<[NOfs)1G7z\"SIhxjk%b5<&O' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/dev/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_GSzkPRcDgIKOV415YsN2MuJ/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
