...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_image_vue__ = __webpack_require__(8);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_27160a16_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_image_vue__ = __webpack_require__(23);
var disposed = false
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_76399e5c_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_thumbnails_vue__ = __webpack_require__(28);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_stacked_vue__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_static_vue__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_slider_vue__ = __webpack_require__(30);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  data: function () {
    ...
    this.data.disable_thumb = wcsvi.data.disable_thumb;
    this.data.thumbImages = false;
    this.data.defaultGallery = false;
  ...
  methods: {
    ...
    photo: function () {
      if (this.slider) $jQsvi(this.$el).find(".gallery-top .swiper-slide-active .sviLigthgallery-trigger").unbind("click").trigger("click");
      //#endregion
      else $jQsvi(this.$el).find(".sviLigthgallery-trigger").unbind("click").trigger("click");
    },
    ...
    getTheDefaultImages: function () {
      let result, $images;

      if ("svidefault" in this.woosvislug) {
        $images = $jQsvi.map(this.woosvislug.svidefault, (v2, i2) => {
          return $jQsvi.map(this.images, (value, index) => {
            if (Number(value.id) == i2.match(/\d+/g).map(Number)) {
              return value;
            }
        ...
        if (this.woosvislug) {
          result = $jQsvi.map(this.woosvislug, (i, slug) => {
            return $jQsvi.map(this.woosvislug[slug], (v2, i2) => {
              return $jQsvi.map(this.images, (value, index) => {
                if (Number(value.id) == i2.match(/\d+/g).map(Number) && !value.product_img) {
                  return value.id;
                }
              });
            });
      ...
      if (!("svidefault" in this.woosvislug)) {
        ...
        $jQsvi.each($images, function (i, v) {
          $jQsvi.each(result, function (i2, v2) {
            if (v.id == v2) delete $images[i];
          });
        });
      }
      this.defaultGallery = $images;
    },
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  mounted: function () {
    this.$bus.$on("thumbImages_" + $jQsvi(this.$root.$el).data("svidx"), thumbImages => {
      thumbImages = this.svithumbsrunner(thumbImages);
      if (wcsvi.data.slider) this.thumbs = thumbImages.main;else this.thumbs = thumbImages;
    });
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  data: function () {
    return {
      ...
      variations_lb: wcsvi.data.variation_thumbnails_lb ? "svi-lbshowpointer" : ""
    };
  },
  methods: {
    possibleActions: function ($evt) {
      ...
      if ($jQsvi(this.$el).closest(".woosvi_strap_thumbs").length > 0 && wcsvi.data.variation_thumbnails_lb) {
        this.items = {
          box: this.lightbox_prep(this.$root.$children[0].thumbs),
          slider: this.$root.$children[0].thumbs
        };
        this.photo();
      }
    },
    photo: function ($event) {
      ...
      if (wcsvi.data.lightbox_iconclick && $event.target.tagName == "IMG")
        //ACTIVA LIGTHBOX SOMENTE NO ICON
        return;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__image_vue__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__thumbnails_vue__ = __webpack_require__(3);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  mounted: function () {
    this.$bus.$on("mainImage_" + $jQsvi(this.$root.$el).data("svidx"), mainImage => {
      if (!mainImage.imageChange && !wcsvi.data.stacked) mainImage = this.svithumbsrunner(mainImage, true);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  props: ["data", "stacked", "strapthumbs"],
  data() {
    return {
      columns: this.stacked ? 1 : this.strapthumbs ? this.strapthumbs : wcsvi.data.columns
    };
  },
  methods: {
    colposition: function (k, index) {
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  mounted: function () {
    let swiperOptionThumbs = {
      ...
      autoHeight: wcsvi.data.position == 0 ? false : true,
      on: {
        init: () => {
          setTimeout(() => {
            this.onReady();
    ...
    this.$bus.$on("thumbImages_" + $jQsvi(this.$root.$el).data("svidx"), thumbImages => {
      if (!wcsvi.data.stacked) {
        thumbImages = this.svithumbsrunner(thumbImages);
      }

      if (!this.isEquivalent(this.mainImage, thumbImages.main)) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_thumbnails_vue__ = __webpack_require__(3);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
  components: {
    thumbnailsComponent: __WEBPACK_IMPORTED_MODULE_0__components_thumbnails_vue__["a" /* default */]
  },
  mounted: function () {
    this.form.find(".reset_variations").on("click", () => {
      this.thumbs = false;
    });

    this.woosvi_strap = this.findWoosvi_strap();
    this.getChosenAttributes();

    if (this.attributes.chosenCount > 0) {
      this.attributeFields.trigger("change");
    }

    this.$bus.$on("varthumbImages_" + this.woosvi_strap.data("svidx"), thumbImages => {
      this.getChosenAttributes();

      if (this.attributes.chosenCount > 0) this.thumbs = wcsvi.data.variation_thumbnails_validate ? thumbImages : thumbImages.slice(0, 1);else this.thumbs = false;
    });
  },
  computed: {
    form: function () {
  ...
  data: function () {
    return {
      ...
      attributes: {},
      woosvi_strap: false,
      columns_variations: wcsvi.data.columns_variations
    };
  },
  methods: {
    getChosenAttributes: function () {
...
var _Svi = __webpack_require__(17);

var _Svi2 = _interopRequireDefault(_Svi);

var _SviThumbs = __webpack_require__(34);

var _SviThumbs2 = _interopRequireDefault(_SviThumbs);
...
_vue2.default.prototype.findSummary = function ($data) {
    var $obj = void 0;
    if ($data) {
        $obj = $data.parent();
    } else {
        $obj = $jQsvi(this.$el).parent();
    }

    return $obj.closest("div[id^='product-']").find(".variations_form");
};

_vue2.default.prototype.svithumbsrunner = function (thumbImages) {
    var run = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;


    if (wcsvi.data.variation_thumbnails && !this.$root.$children[0].type && Object.keys(this.$root.$children[0].woosvislug).length > 0) {
        var _this = this;
        var el = this.$root.$children[0].form;

        var sendImages = JSON.parse(JSON.stringify(thumbImages));

        if (wcsvi.data.slider) sendImages = JSON.parse(JSON.stringify(thumbImages.thumbs));

        if (!run) {

            var refreshId = setInterval(function () {
                if (el.find('.woosvi_strap_thumbs').length > 0) {
                    _this.$bus.$emit("varthumbImages_" + $jQsvi(_this.$root.$el).data("svidx"), sendImages);
                    clearInterval(refreshId);
                }
            }, 10);
        }
        if (wcsvi.data.slider) {
            thumbImages.main = _this.$root.$children[0].defaultGallery;
            thumbImages.thumbs = _this.$root.$children[0].defaultGallery;
        } else {
            if (run) {
                var $key = Object.keys(_this.$root.$children[0].defaultGallery)[0];
                thumbImages = _this.$root.$children[0].defaultGallery[$key];
            } else thumbImages = _this.$root.$children[0].defaultGallery;
        }
        return thumbImages;
    } else {
        return thumbImages;
...
_vue2.default.prototype.findWoosvi_strap = function ($data) {
    var $count = 0;
    var $variations_form = void 0;
    var $obj = void 0;
    if ($data) {
        $obj = $data.parent();
    } else {
    ...
    while ($count < 1) {
        ...
        if ($obj.parent().find(".woosvi_strap").length > 0) {
            $count++;
            $variations_form = $obj.parent().find(".woosvi_strap");
        } else {
            $obj = $obj.parent();
        }
    }
...
if ($jQsvi('.svi-vue-frontend-app').length > 0) {
    ...
    $jQsvi.each($jQsvi('.svi-vue-frontend-app'), function (i, v) {
        var $parent = $jQsvi(this).parent();
        var svidata = $parent.data('svi');
        var $variationsThumbs = void 0;
        if (!svidata.type) $variationsThumbs = _vue2.default.prototype.findSummary($parent);
        ...
        if (wcsvi.data.variation_thumbnails && !svidata.type && Object.keys(svidata.woosvislug).length > 0) {

            $jQsvi.each($variationsThumbs.find('.svi-vue-variationthumbs-app'), function (i, v) {
                new _vue2.default({
                    render: function render(h) {
                        return h(_SviThumbs2.default, {
                            props: {
                                data: svidata
                            }
                        });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Svi_vue__ = __webpack_require__(6);
/* empty harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_911a9dfc_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Svi_vue__ = __webpack_require__(33);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_stacked_vue__ = __webpack_require__(7);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_334a8b22_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_stacked_vue__ = __webpack_require__(24);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var render = function() {
  ...
  return _c(
    ...
    {
      class: [
        this.type == "thumb" ? "svi-thumb" : "svi-mainsection",
        _vm.variations_lb
      ]
    },
    [
            ...
            _c("img", {
              ...
              on: {
                click: [
                  ...
                  function($event) {
                    return _vm.possibleActions($event)
                  }
                ]
              }
            })
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_static_vue__ = __webpack_require__(9);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_0db73ac3_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_static_vue__ = __webpack_require__(29);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var render = function() {
  ...
  return _c("div", { staticClass: "svi-thumbsection" }, [
    _c(
      ...
      [
        _vm._l(_vm.data, function(item, index, k) {
          return [
            item.single.src
              ? _c(
                  "li",
                  { key: item.key, class: _vm.colposition(k, index) },
                  [
                    _c("imageComponent", {
                      attrs: {
                        data: item.thumb,
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_563973b6_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_slider_vue__ = __webpack_require__(32);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_SviThumbs_vue__ = __webpack_require__(12);
/* empty harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_2291af02_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_SviThumbs_vue__ = __webpack_require__(36);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_SviThumbs_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_2291af02_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_SviThumbs_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "assets/src/frontend/SviThumbs.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2291af02", Component.options)
  } else {
    hotAPI.reload("data-v-2291af02", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "woosvi_strap_thumbs" },
    [
      !_vm.disable_thumb && _vm.thumbs
        ? _c("thumbnailsComponent", {
            attrs: {
              data: _vm.thumbs,
              stacked: false,
              strapthumbs: _vm.columns_variations
            }
          })
        : _vm._e()
    ],
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-2291af02", esExports)
  }
}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_PhotoSwipe_vue__ = __webpack_require__(13);
/* empty harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_4f0b451d_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_PhotoSwipe_vue__ = __webpack_require__(38);
var disposed = false
var normalizeComponent = __webpack_require__(0)
/* script */
