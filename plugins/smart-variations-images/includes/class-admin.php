...
class Admin
{
    public function __construct()
    {
        ...
        add_action( 'admin_notices', array( $this, 'display_admin_notice_v4_thumbs' ) );
...
<?php 
    ...
    public function display_admin_notice_v4_thumbs()
    {
        if ( !\PAnD::is_admin_notice_active( 'disablesvithumbs-done-notice-forever' ) ) {
            return;
        }
        $settings_link = '<a href="admin.php?page=woocommerce_svi">' . __( "WooCommerce > SVI", "wc_svi" ) . '</a> <b>Showcase Images under Variations</b>';
        ?>
<div data-dismissible="disablesvithumbs-done-notice-forever" class="notice notice-warning is-dismissible">
<p style="line-height: 1.4em;">
<img src="<?php 
        echo  SVI_URL ;
        ?>/assets/img/svi.png" style="float: left; height: auto; margin-right: 1em; max-width: 90px;">
    <strong>SMART VARIATIONS IMAGES as added an AMAZING NEW FEATURE!</strong>
    <br>
    Now you are able to showcase your <b>variation images</b> <u>under the variations drop down select!</u><br>
    Leave your main gallery untouched and let your clients focus on the variation image on spot!<br>
    This small feature may help you bost your sales maintaining all available images in display!<br>
    Try out this feature now! Activate it here <?php 
        echo  $settings_link ;
        ?>.
</p>
</div>
